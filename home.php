...
<h3><b>Welcome <?php 
 ...
 <div class="card colo-md-4" style="width:250px" >
  ...
  <div class="card-body"><center>
    ...
    <p class="card-text">Xem Các Loại nhà có thể thuê được</p><br>
...
<div class="card colo-md-4" style="width:250px">
  ...
  <div class="card-body"><center>
    ...
    <p class="card-text">Danh sách các chủ sở hữu</p><br>
...
<div class="card colo-md-4" style="width:250px">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Danh sách những Người Cho thuê</p><br>
...
<br>
 ...
 <div class="card colo-md-4" style="width:250px" >
  ...
  <div class="card-body"><center>
    ...
    <p class="card-text">Đặt Phòng Tại Đây</p><br>
